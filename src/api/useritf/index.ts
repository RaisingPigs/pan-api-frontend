...
export async function reqCheckInvokeAuth(data: UserItfAPI.InvokeAuthCheckReq) {
  return request.post<any, BaseResponse<boolean>>("/user-itf/check-invoke-auth", data);
}

export async function reqInvokeCountIncrement(data: UserItfAPI.InvokeCountReq) {
  return request.put<any, BaseResponse<never>>("/user-itf/count-increment", data);
}
...
export async function reqListUserItf(data: UserItfAPI.UserItfQueryReq) {
  return request.post<any, BaseResponse<UserItfAPI.UserItfVO[]>>("/user-itf/list", data);
}

export async function reqListUserItfByPage(data: UserItfAPI.UserItfQueryReq) {
  return request.post<any, BaseResponse<UserItfAPI.IPageUserItfVO>>("/user-itf/list/page", data);
}
