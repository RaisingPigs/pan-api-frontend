...
import StatisticCard from "@/views/statistic/components/StatisticCard/index.vue";
import PieCard from "@/views/statistic/components/PieCard/index.vue";
import BarCard from "@/views/statistic/components/BarCard/index.vue";
import { reqCount, reqCountInvokeTop10, reqCountUserInvokeTop10 } from "@/api/statistics";
import { onMounted, ref } from "vue";
import type { StatisticCount } from "@/views/statistic/components/StatisticCard/type";
import { PieData } from "@/views/statistic/components/PieCard/type";
import { BarData } from "@/views/statistic/components/BarCard/type";
